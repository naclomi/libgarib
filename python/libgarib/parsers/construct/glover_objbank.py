...
glover_objbank__geometry = Struct(
	...
	'colors' / Pointer(this.colors_ptr, If(this.colors_ptr != 0, Array(this.num_vertices, Int32ub))),
	'norms' / Pointer(this.norms_ptr, If(this.norms_ptr != 0, Array(this.num_faces, Int32ub))),
)
