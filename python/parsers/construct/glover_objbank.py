...
glover_objbank__geometry = Struct(
	...
	'u1' / Pointer(this.u1_ptr, If(this.u1_ptr != 0, Array(this.num_faces, Int32ub))),
	'uvs' / Pointer(this.uvs_ptr, If(this.uvs_ptr != 0, Array(this.num_faces, LazyBound(lambda: glover_objbank__uv)))),
	'colors_norms' / Pointer(this.colors_norms_ptr, If(this.colors_norms_ptr != 0, Array(this.num_vertices, Int32ub))),
)
